...
* @see https://v0.dev/t/BY9qWJnzdgC
...
function StripedGreenCircleHole(props) {
  return (
    <svg
      {...props}
    ...
    >
        ...
        <circle cx="50" cy="50" r="30" fill="none" stroke="url(#stripes)" stroke-width="20" />
...
function StripedGreenCircleSolid(props) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
        ...
        <circle cx="50" cy="50" r="10" fill="none" stroke="url(#stripes)" stroke-width="50" />
...
function StripedGreenSquareHole(props) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
